            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Chhatrapati Shivaji Maharaj Hospital</h5>
...
<!-- Nurse login --> <!-- Nurse and Receptionist logins centered -->
<div class="row justify-content-center">
            <!-- Nurse login -->
            <div class="col-sm-4 blog-smk">
                <div class="blog-single">
                    <img src="assets/images/nurse.jpeg" alt="">
                    <div class="blog-single-det text-center"> <!-- Centering text within the div -->
                        <h6>Nurse Login</h6>
            ...
            <div class="col-sm-4 blog-smk">
                <div class="blog-single">
                    <img src="assets/images/receptionist.jpeg" alt="">
                    <div class="blog-single-det text-center"> <!-- Centering text within the div -->
