...
if(isset($_POST['submit']))
{
    ...
    if($num>0)
    {
        ...
        $status=1;
        // Code Logs
        $log=mysqli_query($con,"insert into receptionistslog(uid,username,userip,status) values('$uid','$uname','$uip','$status')");
    ...
    else
    {
        $uip=$_SERVER['REMOTE_ADDR'];
        $status=0;
        mysqli_query($con,"insert into receptionistslog(username,userip,status) values('$uname','$uip','$status')");
